...
// pra ler item por item da array, funcao callback
listadecarros.map((carros, posicao) => {
   let cardcarro = document.getElementById ("cards");
   cardcarro.innerHTML += ` 
   <div class="col-md-4"> 
            <div class="card m-2">
                <img src="${carros.img}" class="card-img-top" alt="...">
                <div class="card-body">
                  <h5 class="card-title">${carros.nome}</h5>
...
// += para aparece todos os carros na tela

function zoomimg (posicao){
  let carrosselecionado = listadecarros[posicao];
  document.getElementById("nomescarros").innerHTML = carrosselecionado.nome;
  document.getElementById("descricaocarros").innerHTML = carrosselecionado.descricao;
  document.getElementById("imgmodal").src = carrosselecionado.img;
